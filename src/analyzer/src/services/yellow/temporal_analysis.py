"""Yellow taxi temporal analysis implementation."""
...
_PICKUP_COL = "tpep_pickup_datetime"
...
class YellowTemporalAnalysis(BaseTemporalAnalysis):
    """Temporal analysis for yellow taxi data."""

    def analyze(self, df: pl.DataFrame) -> StepResult:
        """Run temporal analysis on yellow taxi dataframe.
        ...
        # decomposition with period=24 (hourly data, daily cycle)
        ...
        # detail parquet: decomposition + rolling stats
        detail = {
...
if __name__ == "__main__":
    ...
    result = YellowTemporalAnalysis().analyze(df=sample)
