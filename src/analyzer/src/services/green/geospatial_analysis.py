"""Green taxi geospatial analysis implementation."""
...
class GreenGeospatialAnalysis(BaseGeospatialAnalysis):
    """Geospatial analysis for green taxi data."""

    def analyze(self, df: pl.DataFrame) -> StepResult:
        """Run geospatial analysis on green taxi dataframe.
...
if __name__ == "__main__":
    ...
    result = GreenGeospatialAnalysis().analyze(df=sample)
