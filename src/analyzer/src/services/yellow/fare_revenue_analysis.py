"""Yellow taxi fare revenue analysis implementation."""
...
_DROPOFF_COL = "tpep_dropoff_datetime"
_SURCHARGE_COLS = [
    "extra",
    "mta_tax",
...
class YellowFareRevenueAnalysis(BaseFareRevenueAnalysis):
    """Fare revenue analysis for yellow taxi data."""

    def analyze(self, df: pl.DataFrame) -> StepResult:
        """Run fare revenue analysis on yellow taxi dataframe.
...
if __name__ == "__main__":
    ...
    result = YellowFareRevenueAnalysis().analyze(df=sample)
